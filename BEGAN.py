...
class BEGAN(object):
    ...
    def discriminator(self, x, is_training=True, reuse=False):
        ...
        with tf.variable_scope("discriminator", reuse=reuse):
            ...
            code = tf.nn.relu(bn(linear(net, 32, scope='d_fc2'), is_training=is_training, scope='d_bn2'))
            ...
            out = tf.nn.sigmoid(deconv2d(net, [self.batch_size, 32, 32, 3], 4, 4, 2, 2, name='d_dc4'))
